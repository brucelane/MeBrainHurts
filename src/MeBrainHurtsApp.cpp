...
class MeBrainHurtsApp : public App {
public:
	MeBrainHurtsApp();
...
MeBrainHurtsApp::MeBrainHurtsApp() 
{
...
void MeBrainHurtsApp::createPrimitivesPositionsFromCube()
{
	mPosCoords.clear();
	mIndices.clear();
...
gl::VboMeshRef MeBrainHurtsApp::createPrimitivePyramidFromPoints(vec3 point1, vec3 point2, vec3 point3, vec3 point4, bool cavity)
{
...
void MeBrainHurtsApp::setSpheresPositions(const std::vector<ci::vec3> &posCoords, const std::vector<uint16_t> &indices)
{
...
void MeBrainHurtsApp::setPyramidsPositions(const std::vector<ci::vec3> &posCoords, const std::vector<uint16_t> &indices)
{
...
vec3 MeBrainHurtsApp::computeTriangleGravitycenter(const vec3 &point1, const vec3 &point2, const vec3 &point3)
{
...
mat4 MeBrainHurtsApp::rotationAlign(vec3 d, vec3 z)
{
	vec3  v = cross(z, d);
	float c = dot(z, d);
	float k = 1.0 / (1.0 + c);
...
vec3 MeBrainHurtsApp::computeTriangleNormal(const vec3 &pos1, const vec3 &pos2, const vec3 &pos3)
{
	vec3 e0 = pos2 - pos1;
	vec3 e1 = pos3 - pos1;
...
void MeBrainHurtsApp::sortIndicesCopy(const std::vector<uint16_t> &indices)
{
...
void MeBrainHurtsApp::uniqueVertexsCopy(const std::vector<vec3> &vertexPositions)
{
...
void MeBrainHurtsApp::subdivide(int mSubdivision)
{
	int subCounter = 0;
...
float MeBrainHurtsApp::linearize(float a0, float a1, float b0, float b1, float in)
{
	return ((in - a0) / (a1 - a0)) * (b1 - b0) + b0;
}
void MeBrainHurtsApp::toggleCursorVisibility(bool visible)
{
	if (visible)
	{
		showCursor();
...
void MeBrainHurtsApp::fileDrop(FileDropEvent event)
{
	
}

void MeBrainHurtsApp::mouseMove(MouseEvent event)
{
	
}

void MeBrainHurtsApp::mouseDown(MouseEvent event)
{
	mIsBeat = true;
	
}

void MeBrainHurtsApp::mouseDrag(MouseEvent event)
{

	
}

void MeBrainHurtsApp::mouseUp(MouseEvent event)
{

	
}

void MeBrainHurtsApp::keyDown(KeyEvent event)
{

	
}

void MeBrainHurtsApp::keyUp(KeyEvent event)
{

	
}
void MeBrainHurtsApp::cleanup()
{
...
void MeBrainHurtsApp::draw()
{
	...
	// Test Render to the screen
	{
		...
		// https://discourse.libcinder.org/t/source-code-tetrahedron-based-particles-system-2-with-source-code/2033/7
...
void MeBrainHurtsApp::createGeometry()
{
	gl::VboMeshRef  rect = gl::VboMesh::create(geom::Rect());
...
void MeBrainHurtsApp::loadTextures()
{
	// Load the textures.
...
// Save renderFbo
void MeBrainHurtsApp::saveImage()
{
	//for 30 fps
...
void MeBrainHurtsApp::loadShaders()
{
	try {
...
void MeBrainHurtsApp::createParams()
{
...
void MeBrainHurtsApp::setXMLAnimationPhases()
{
...
void MeBrainHurtsApp::transition_0(bool start)
{
	if (start == true)
	{
		mSizeCoef = 0;
...
void MeBrainHurtsApp::transition_1(bool start)
{
	if (start == true)
	{
...
void MeBrainHurtsApp::transition_2(bool start)
{
	if (start == true)
	{
		mAdjustSize = true;
...
void MeBrainHurtsApp::transition_3(bool start)
{
	if (start == true)
	{
		mAdjustSize = true;
...
CINDER_APP(MeBrainHurtsApp, RendererGl(RendererGl::Options().msaa(32)), prepareSettings)
